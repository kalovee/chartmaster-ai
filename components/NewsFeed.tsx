...
const NewsFeed: React.FC<NewsFeedProps> = ({ chunks }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800/50 pb-6">
        ...
        {validChunks.map((chunk, idx) => {
          ...
          return (
            <a
              ...
              className="group block p-6 bg-gray-50 dark:bg-gray-900/30 hover:bg-gray-100 dark:hover:bg-gray-800/50 border border-gray-200 dark:border-gray-800 hover:border-blue-500/40 rounded-2xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-1"
            >
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center group-hover:bg-blue-500 transition-colors duration-300">
                ...
                <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors line-clamp-2 leading-relaxed font-sans">
                  {chunk.web.title}
                </h4>
                <div className="flex items-center gap-3">
                  <div className="h-[1px] flex-grow bg-gradient-to-r from-gray-200 dark:from-gray-800 to-transparent group-hover:from-blue-500/30 transition-colors"></div>
                  <div className="flex gap-0.5">
                    {[1,2,3,4].map(i => <div key={i} className="w-1 h-1 rounded-full bg-gray-200 dark:bg-gray-800 group-hover:bg-blue-500/50 transition-colors"></div>)}
                  </div>
                </div>
              </div>
            </a>
